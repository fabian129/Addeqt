...
export default function ChristofferPage() {
  return (
    <>
      ...
      <main className="chm-page">
        <div className="chm-container">
          ...
          <nav className="chm-breadcrumb font-mono">
            ...
            <span>Team</span>
            <span className="chm-breadcrumb-sep">/</span>
            <span className="chm-breadcrumb-active">Christoffer Mohammar</span>
          </nav>
          ...
          <div className="chm-grid">
            ...
            <div className="chm-content">
              ...
              <div className="chm-header">
                ...
                <div className="chm-contact-links">
                  <a
                    href="mailto:christoffer@addeqt.com"
                  ...
                  >
                    ...
                    <span className="chm-contact-reveal">christoffer@addeqt.com</span>
                  </a>
                  <a
                    href="https://www.linkedin.com/in/christoffermohammar"
                    target="_blank"
              ...
              <blockquote className="chm-quote">
                <p className="font-display">
                  &ldquo;Vi finns till för att ge alla tillgång till riktigt
                  oberoende rådgivning — oavsett hur stor eller liten
                  förmögenheten är.&rdquo;
                </p>
              </blockquote>
            ...
            <aside className="chm-aside">
              ...
              <div className="chm-portrait">
                <Image
                  src="/images/team/CHM bild 191113 (1).jpg"
                  alt="Christoffer Mohammar — VD & Grundare, AddEqt"
                  fill
              ...
              <div className="chm-card">
                <h3 className="font-display chm-card-title">Kontakta Christoffer</h3>
                <p className="chm-card-desc">
                  Diskutera din ekonomiska situation direkt med Christoffer och teamet på AddEqt.
                </p>
      ...
      <style>{`
        /* ═══════════════════════════════════════
           CHRISTOFFER PAGE — Editorial Profile
           ═══════════════════════════════════════ */
