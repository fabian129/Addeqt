...
export default function FredrikLidmarkPage() {
  return (
    <>
      ...
      <main className="chm-page">
        <div className="chm-container">
          ...
          <nav className="chm-breadcrumb font-mono">
            ...
            <span>Team</span>
            <span className="chm-breadcrumb-sep">/</span>
            <span className="chm-breadcrumb-active">Fredrik Lidmark</span>
          </nav>
          ...
          <div className="chm-grid">
            ...
            <div className="chm-content">
              ...
              <div className="chm-header">
                ...
                <div className="chm-contact-links">
                  <a
                    href="mailto:fredrik.lidmark@addeqt.com"
                  ...
                  >
                    ...
                    <span className="chm-contact-reveal">fredrik.lidmark@addeqt.com</span>
                  </a>
                  <a
                    href="#"
                    target="_blank"
              ...
              <blockquote className="chm-quote">
                <p className="font-display">
                  &ldquo;Varje portfölj vi bygger är unik — för det är varje kunds situation.&rdquo;
                </p>
              </blockquote>
              ...
              <div className="chm-bio">
                <p>
                  Fredrik Lidmark är <strong>Partner</strong> på AddEqt och ansvarar för
                  bolagets kapitalförvaltning. Med en gedigen bakgrund inom portföljförvaltning
                  och finansiell analys har han byggt upp en djup förståelse för de globala
                  kapitalmarknaderna. Fredriks filosofi vilar på disciplinerad riskhantering
                  och en analytisk approach som sätter kundens långsiktiga mål i centrum.
                </p>
                <p>
                  Under sin karriär har Fredrik arbetat med <strong>institutionella och privata
                  portföljer</strong> i varierande marknadsklimat, vilket gett honom en unik
                  förmåga att navigera komplexa marknadssituationer. Han är övertygad om att
                  framgångsrik förvaltning kräver en kombination av kvantitativ analys,
                  makroekonomisk förståelse och en orubblig disciplin i investeringsprocessen.
                </p>
                <p>
                  På AddEqt driver Fredrik utvecklingen av bolagets <strong>förvaltningsstrategier
                  och analysramverk</strong>, med ambitionen att leverera riskjusterad avkastning
                  i toppklass. Utanför kontoret är Fredrik en engagerad idrottsentusiast med ett
                  brinnande intresse för segling och alpint.
                </p>
              </div>
            ...
            <aside className="chm-aside">
              ...
              <div className="chm-portrait">
                <Image
                  src="/images/team/fredrik-lidmark.jpg"
                  alt="Fredrik Lidmark — Partner, AddEqt"
                  fill
              ...
              <div className="chm-card">
                <h3 className="font-display chm-card-title">Kontakta Fredrik</h3>
                <p className="chm-card-desc">
                  Diskutera din ekonomiska situation direkt med Fredrik och teamet på AddEqt.
                </p>
      ...
      <style>{`
        /* ═══════════════════════════════════════
           FREDRIK LIDMARK PAGE — Editorial Profile
           ═══════════════════════════════════════ */
