...
export default function FredrikStrombergPage() {
  return (
    <>
      ...
      <main className="chm-page">
        <div className="chm-container">
          ...
          <nav className="chm-breadcrumb font-mono">
            ...
            <span>Team</span>
            <span className="chm-breadcrumb-sep">/</span>
            <span className="chm-breadcrumb-active">Fredrik Strömberg</span>
          </nav>
            ...
            <div className="chm-content">
              ...
              <div className="chm-header">
                ...
                <div className="chm-contact-links">
                  <a
                    href="mailto:fredrik.stromberg@addeqt.com"
                  ...
                  >
                    ...
                    <span className="chm-contact-reveal">fredrik.stromberg@addeqt.com</span>
                  </a>
                  <a
                    href="#"
                    target="_blank"
              ...
              <blockquote className="chm-quote">
                <p className="font-display">
                  &ldquo;Transparens och disciplin slår spekulation — varje gång.&rdquo;
                </p>
              </blockquote>
      ...
      <style>{`
        /* ═══════════════════════════════════════
           FREDRIK STRÖMBERG PAGE — Editorial Profile
           ═══════════════════════════════════════ */
