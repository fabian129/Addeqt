...
export default function ChristianPage() {
  return (
    <>
      ...
      <main className="chm-page">
        <div className="chm-container">
          ...
          <nav className="chm-breadcrumb font-mono">
            ...
            <span>Team</span>
            <span className="chm-breadcrumb-sep">/</span>
            <span className="chm-breadcrumb-active">Christian Holm Svensson</span>
          </nav>
          ...
          <div className="chm-grid">
            ...
            <div className="chm-content">
              ...
              <div className="chm-header">
                ...
                <div className="chm-contact-links">
                  <a
                    href="mailto:christian@addeqt.com"
                  ...
                  >
                    ...
                    <span className="chm-contact-reveal">christian@addeqt.com</span>
                  </a>
                  <a
                    href="#"
                    target="_blank"
              ...
              <blockquote className="chm-quote">
                <p className="font-display">
                  &ldquo;Långsiktig rådgivning handlar om att förstå hela bilden — inte bara siffrorna.&rdquo;
                </p>
              </blockquote>
              ...
              <div className="chm-bio">
                <p>
                  Christian Holm Svensson är <strong>Partner</strong> på AddEqt med ett djupt
                  engagemang för att bygga långsiktiga kundrelationer grundade i förtroende och
                  transparens. Med en omfattande bakgrund inom <strong>private banking och
                  förmögenhetsrådgivning</strong> har Christian hjälpt privatpersoner, familjer
                  och entreprenörer att navigera komplexa finansiella landskap under många år.
                </p>
                <p>
                  Christians styrka ligger i förmågan att se helheten — att förstå inte bara
                  kundens ekonomiska situation utan även de <strong>livsval och värderingar</strong> som
                  formar deras behov. Han arbetar metodiskt med att skapa skräddarsydda
                  finansiella planer som balanserar trygghet med tillväxt, och som utvecklas i
                  takt med kundens förändrade livssituation.
                </p>
                <p>
                  På AddEqt ansvarar Christian för att vidareutveckla bolagets
                  rådgivningserbjudande med fokus på <strong>helhetstjänster inom finansiell
                  planering</strong>. Han drivs av övertygelsen att riktigt bra rådgivning börjar
                  med att lyssna — och att de bästa resultaten uppstår när rådgivaren förstår
                  hela bilden. Utanför kontoret ägnar Christian sin tid åt familjen, golf och
                  en passion för arkitektur och design.
                </p>
              </div>
            ...
            <aside className="chm-aside">
              ...
              <div className="chm-portrait">
                <Image
                  src="/images/team/christian.jpg"
                  alt="Christian Holm Svensson — Partner, AddEqt"
                  fill
              ...
              <div className="chm-card">
                <h3 className="font-display chm-card-title">Kontakta Christian</h3>
                <p className="chm-card-desc">
                  Diskutera din ekonomiska situation direkt med Christian och teamet på AddEqt.
                </p>
      ...
      <style>{`
        /* ═══════════════════════════════════════
           CHRISTIAN PAGE — Editorial Profile
           ═══════════════════════════════════════ */
