      ...
      <main className="chm-page">
        <div className="chm-container">
          ...
          <nav className="chm-breadcrumb font-mono">
            ...
            <span>Team</span>
            <span className="chm-breadcrumb-sep">/</span>
            <span className="chm-breadcrumb-active">Mats Gunnå</span>
          </nav>
          ...
          <div className="chm-grid">
            ...
            <div className="chm-content">
              ...
              <div className="chm-header">
                ...
                <div className="chm-contact-links">
                  ...
                  >
                    ...
                    <span className="chm-contact-reveal">mats@addeqt.com</span>
                  </a>
                  <a
                    href="#"
                    target="_blank"
              ...
              <blockquote className="chm-quote">
                <p className="font-display">
                  &ldquo;Trygghet kommer från att ha en plan — och någon som ser till att den följs.&rdquo;
                </p>
              </blockquote>
            ...
            <aside className="chm-aside">
              ...
              <div className="chm-card">
                <h3 className="font-display chm-card-title">Kontakta Mats</h3>
                <p className="chm-card-desc">
                  Diskutera din ekonomiska situation direkt med Mats och teamet på AddEqt.
                </p>
